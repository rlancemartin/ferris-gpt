...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>Ferris GPT</title>
        <meta
          name="description"
          content={`AI-powered search and chat for the Tim Ferris podcast. `}
        />
        <meta
          name="viewport"
        ...
        <div className="flex-1 overflow-auto">
          <div className="mx-auto flex h-full w-full max-w-[750px] flex-col items-center px-3 pt-4 sm:pt-8">
            ...
            {apiKey.length === 51 ? (
              <div className="relative w-full mt-4">
                ...
                <input
                  ...
                  type="text"
                  placeholder="What is the 4 hour work week?"
                  value={query}
            ...
            {loading ? (
              ...
              <div className="mt-6 text-center text-lg">{`AI-powered search and chat for the Tim Ferris podcast.`}</div>
            )}
          </div>
        </div>
        <Footer />
